...
{
    defineTypeNameAndDebug(myMultiFieldValue, 0);
    addToRunTimeSelectionTable(functionObject, myMultiFieldValue, dictionary);
}
}
}
...
const Foam::Enum
<
    Foam::functionObjects::fieldValues::myMultiFieldValue::operationType
>
Foam::functionObjects::fieldValues::myMultiFieldValue::operationTypeNames_
({
...
// Implementation
#include "myMultiFieldValueImpl.C"


// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::functionObjects::fieldValues::myMultiFieldValue::writeFileHeader
(
...
Foam::functionObjects::fieldValues::myMultiFieldValue::myMultiFieldValue
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::fieldValues::myMultiFieldValue::read
(
    const dictionary& dict
)
{
...
bool Foam::functionObjects::fieldValues::myMultiFieldValue::write()
{
    if (functions_.empty())
    {
        return false;
...
bool Foam::functionObjects::fieldValues::myMultiFieldValue::execute()
{
    return true;
}
